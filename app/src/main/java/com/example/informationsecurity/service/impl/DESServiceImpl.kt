 ...
 **/
class DESServiceImpl : BaseEncodeDecodeService {

    /**
     * 获取算法名称
     * @return 算法名称
     */
    override fun getName() = "DES加解密"
    ...
    override fun encode(key: String?, decodedString: String): String {
        return EncryptUtil.getInstance().DESencode(decodedString, key)
    }
    ...
    override fun decode(key: String?, encodedString: String): String {
        return EncryptUtil.getInstance().DESdecode(encodedString, key)
    }
